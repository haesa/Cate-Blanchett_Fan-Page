<?php
  ...
  $number = $_GET['number'];
  $sql = "select article_id ,title, content, writer, date from article where article_id =".$number.";";
    ...
    <div class="wrap">
      <div class="contents">
        ...
        <div class="view_btn">
          ...
          <button class="view_btn1" onclick="location.href='./modify_board.php?number=<?=$number?>'">수정</button>
          <button class="view_btn1" onclick="location.href='./delete_board.php?number=<?=$number?>'">삭제</button>
        </div>
      </div>
    </div>
  </body>
